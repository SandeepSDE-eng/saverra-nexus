...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Saverra Realty | Premier Property Consultant in Ghatkopar East, Mumbai" },
      { name: "description", content: "Saverra Realty is Mumbai's premier RERA-registered real estate consultancy in Ghatkopar East. Discover luxury 1, 2, 3 BHK flats & commercial properties." },
      { name: "keywords", content: "Saverra Realty, Property Consultant Ghatkopar East, Real Estate Agent Ghatkopar East, Luxury Flats Ghatkopar, Commercial Property Mumbai, RERA Registered Broker Ghatkopar, Real Estate Firm Mumbai" },
      ...
      { property: "og:title", content: "Saverra Realty | Premier Property Consultant in Ghatkopar East, Mumbai" },
      ...
      { name: "twitter:title", content: "Saverra Realty | Premier Property Consultant in Ghatkopar East" },
