...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SAVERRA — Unlocking The Extraordinary, Every Single Day" },
      { property: "og:description", content: "Premium Homes. Prime Locations. Promising Futures. Explore SAVERRA's portfolio of luxury residences and commercial spaces." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "SAVERRA — Premium Real Estate" },
      { name: "twitter:description", content: "Premium Homes. Prime Locations. Promising Futures." },
    ],
    links: [
