...
preload_js = """require('dotenv').config({ path: '/home/u278286324/domains/saverrarealty.com/hbuilds/config/.env' });
...
print("Preload script updated and Passenger restarted!")
client.close()
